...
/**
 * Created by Fallwater潘建波 on 2018/03/08.
 * github:https://github.com/ithedan/TextViewDrawable
 */
...
public class TextViewDrawable extends AppCompatTextView {
    ...
    private void setDrawable(Drawable drawable, int tag, int drawableWidth, int drawableHeight) {
        ...
        /**
         * 这里的SetBounds中对应的坐标是drawble自己的坐标，需要把根据自己的原来坐标来偏移
         */
        drawable.setBounds(left, top, right, bottom);
        Log.d("fallwater",
                "tag:" + tag + "\n" + "textView left:" + getLeft() + "textView top:" + getTop() + ",textView right:"
                        + getRight() + ",textView bottom:" + getBottom());
    }
}
